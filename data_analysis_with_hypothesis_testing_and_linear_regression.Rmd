---
title: "Data Analysis with Hypothesis Testing and Linear Regression: Exploring Factors Affecting Life Expectancy"
author: "..., Alina Yildir, ..."
date: "2024-09-30"
output: pdf_document
---
...
```{r}
library(ggplot2)
ggplot(data1_filtered, aes(x = Schooling, y = `Life.expectancy`)) +
  geom_point() +
  labs(title = "Relationship between Schooling and Life Expectancy",
