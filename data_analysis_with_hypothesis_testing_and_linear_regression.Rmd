...
The analysis utilizes a [comprehensive dataset](https://www.kaggle.com/datasets/kumarajarshi/life-expectancy-who) containing 2,938 observations and 22 variables, which include demographic, health, and economic indicators. Key variables analyzed include adult mortality rates, infant deaths, healthcare expenditure, vaccination rates, and socio-economic status. The study aims to provide insights into how these factors influence life expectancy, particularly in developing nations where health disparities are most pronounced.
...
There is a significant relationship between schooling and life expectancy as shown by the very low p value from the regression model. For every year of schooling we expect life expectancy to increase by about 2.32 years, and about 61% of the variance in life expectancy can be explained by schooling.
...
This research highlights the importance of data-driven approaches in understanding life expectancy. Utilizing a comprehensive dataset of 2,938 observations and 22 variables, the research focuses on health, socio-economic, and demographic indicators that contribute to life expectancy rates. The dataset includes critical variables such as adult mortality rates, infant deaths, healthcare expenditure, vaccination rates, and socio-economic status, capturing life expectancy data from developing nations like Afghanistan, where life expectancy has shown significant variability over the years. The authors employed statistical techniques such as hypothesis testing and linear regression to analyze the data, with hypothesis testing helping to determine whether observed differences in life expectancy can be attributed to specific health or socio-economic factors rather than random chance, and linear regression allowing for understanding the relationships between dependent (life expectancy) and independent variables (health indicators). 

The exploratory data analysis phase revealed that the mean life expectancy across all observations was approximately 69.22 years, with a median of 72.10 years, while adult mortality rates varied widely, indicating disparities in health outcomes between countries. The study's findings indicated that healthcare expenditure emerged as a significant predictor of life expectancy, with countries investing more in healthcare tending to report longer lifespans. Additionally, socio-economic factors such as income composition and education levels were found to correlate positively with life expectancy outcomes, aligning with existing literature suggesting that improved socio-economic conditions lead to better health outcomes. 

This research serves as a critical resource for policymakers aiming to address health disparities and improve longevity in populations worldwide, offering a robust framework for future studies exploring similar themes in public health research
